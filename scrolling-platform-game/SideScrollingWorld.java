...
public class SideScrollingWorld extends World
{
    ...
    GreenfootSound sound = new GreenfootSound("a.mp3");
    GreenfootSound sound1 = new GreenfootSound("lost.mp3");
    GreenfootSound sound2 = new GreenfootSound("won.mp3");
    /**
...
/**
 * return each sound objects
 */
public GreenfootSound sound()
{
    return sound;
}
public GreenfootSound sound1()
{
    return sound1;
}
public GreenfootSound sound2()
{
    return sound2;
    }
}
